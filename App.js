...
export default function App() {
  ...
  const TabNavigator = () => (
    ...
    >
      <Tab.Screen name="All">{() => <TodoList tasks={tasks} addTask={addTask} deleteTask={deleteTask} toggleCompleted={toggleCompleted} updateFlagColor={updateFlagColor} filter="All" />}</Tab.Screen>
      <Tab.Screen name="Personal">{() => <TodoList tasks={tasks} addTask={addTask} deleteTask={deleteTask} toggleCompleted={toggleCompleted} updateFlagColor={updateFlagColor} filter="Personal" />}</Tab.Screen>
      <Tab.Screen name="Work">{() => <TodoList tasks={tasks} addTask={addTask} deleteTask={deleteTask} toggleCompleted={toggleCompleted} updateFlagColor={updateFlagColor} filter="Work" />}</Tab.Screen>
      <Tab.Screen name="Wishlist">{() => <TodoList tasks={tasks} addTask={addTask} deleteTask={deleteTask} toggleCompleted={toggleCompleted} updateFlagColor={updateFlagColor} filter="Wishlist" />}</Tab.Screen>
    </Tab.Navigator>
  );
        ...
        <Drawer.Screen name="Taskly">
          {() => (
            <Stack.Navigator initialRouteName="Tabs">
              ...
              <Stack.Screen name="TaskDetail" component={TaskDetail} options={({ route }) => ({ title: route.params.task.text })} />
            </Stack.Navigator>
          )}
        </Drawer.Screen>
      </Drawer.Navigator>
